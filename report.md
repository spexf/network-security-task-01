...
In conclusion, this lab session successfully demonstrated the process of setting up a virtual lab environment using Docker, capturing network traffic, and analyzing the data with Wireshark. We addressed challenges such as missing tools on the client container and issues capturing traffic on Windows by customizing Docker images and adjusting our configurations. The traffic analysis validated the proper operation of network protocols across different OSI layers—from ARP at Layer 2 and TCP handshakes at Layer 4 to HTTP transactions at Layer 7. Additionally, running Nmap with the -sC option provided further insights into the scanned ports. Overall, this exercise reinforced our understanding of containerized network environments and the importance of detailed traffic analysis in network security tasks.
